const TweenDefine	= require('./TweenDefine');
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	Goto(percent)
	{
		...
		if (typeof this.start.scaleX != "undefined")
		{
			scaleX = (this.end.scaleX - this.start.scaleX) * percent;
			this.object.scale.x = this.start.scaleX + scaleX;
		}

		if (typeof this.start.scaleY != "undefined")
		{
			scaleY = (this.end.scaleY - this.start.scaleY) * percent;
			this.object.scale.y = this.start.scaleY + scaleY;
		}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	Update(deltaTime)
	{
		...
		switch (this.type)
		{
			...
			case TweenDefine.CUBIC_EASE_IN:
			{
				this.percent = this.CubicEaseIn(1 - this.timer.GetTimePercent());
				break;
			}
			case TweenDefine.CUBIC_EASE_OUT:
			{
				this.percent = this.CubicEaseOut(1 - this.timer.GetTimePercent());
				break;
			}
			case TweenDefine.CUBIC_EASE_INOUT:
			{
				this.percent = this.CubicEaseInOut(1 - this.timer.GetTimePercent());
				break;
			}
			default:
			{
